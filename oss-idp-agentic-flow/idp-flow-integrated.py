...
qwen_model = "qwen3-vllm"
qwen_vision_model = "vllm-server-qwen-vision"
extraction_llm = ChatOpenAI(model=qwen_vision_model, temperature=0.1, max_tokens=5000, api_key=model_key, base_url=api_gateway_url)
rules_llm = ChatOpenAI(model=qwen_model, temperature=0.1, max_tokens=5000, api_key=model_key, base_url=api_gateway_url)
